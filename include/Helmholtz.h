...
public:
    ...
    Props p_T(double p, double T) const override;
    Props v_u(double v, double u) const override;
...
protected:
    ...
    virtual double alpha(double delta, double tau) const = 0;
    ...
    virtual double dalpha_ddelta(double delta, double tau) const = 0;
    ...
    virtual double dalpha_dtau(double delta, double tau) const = 0;
    ...
    virtual double d2alpha_ddelta2(double delta, double tau) const = 0;
    ...
    virtual double d2alpha_dtau2(double delta, double tau) const = 0;
    ...
    virtual double d2alpha_ddeltatau(double delta, double tau) const = 0;
    ...
    double rho_from_p_T(double p, double T) const;
    ...
    double tau_from_v_u(double v, double u) const;
    ...
    virtual double mu_from_rho_T(double rho, double T) const = 0;
    ...
    virtual double k_from_rho_T(double rho, double T) const = 0;
